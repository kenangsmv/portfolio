  ...
  return (
    <div className="static-container " id="project">
      <h1 className="footer-content title-footer m1" id="project">
        ...
        <span class="tag-arrow"> {"<"} <span className="tag ">works{state?<BsFillPauseFill className="p-icons-pouse " onClick={Pouse}/>:<FaPlay fontSize={64} className="p-icons-play" onClick={Play}/>}</span>  <span class="attr">class</span> <span class="equal">=</span>
            <span class="string">{"'"}selected{"'"}</span>{"/>"}</span>
      </h1>
